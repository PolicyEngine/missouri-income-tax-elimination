...
export default function ImpactAnalysis({ request, triggered, maxEarnings, reform }: Props) {
  const { data, isLoading, error } = useHouseholdImpact(request, triggered, reform ?? {});
    ...
    <div className="space-y-8">
      ...
      <div className="bg-white border rounded-lg p-6">
        <h3 className="text-lg font-semibold mb-1 text-gray-800">
          Change in net income under the selected Missouri reform
        </h3>
